...
import { Menu, Settings, User, RefreshCw, Bookmark, ChevronDown } from "lucide-react"
        ...
        <main className="flex-1 overflow-auto">
          <div className="container mx-auto px-4 py-6">
            ...
            <Tabs defaultValue="day1" className="w-full">
              <TabsList className="mb-4 grid w-full grid-cols-3 md:w-auto md:grid-cols-7">
                <TabsTrigger value="day1">Day 1</TabsTrigger>
                <TabsTrigger value="day2">Day 2</TabsTrigger>
                <TabsTrigger value="day3">Day 3</TabsTrigger>
                <TabsTrigger value="day4" className="hidden md:inline-flex">
                  Day 4
                </TabsTrigger>
                <TabsTrigger value="day5" className="hidden md:inline-flex">
                  Day 5
                </TabsTrigger>
                <TabsTrigger value="day6" className="hidden md:inline-flex">
                  Day 6
                </TabsTrigger>
                <TabsTrigger value="day7" className="hidden md:inline-flex">
                  Day 7
                </TabsTrigger>
              </TabsList>
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="rounded-md bg-blue-50 p-3">
                          ...
                          <p className="text-xs text-blue-700">
                            The protein in Greek yogurt and healthy fats from walnuts slow down glucose absorption,
                            while berries provide antioxidants and fiber with minimal impact on blood sugar.
                          </p>
                        </div>
                      </div>
                    </CardContent>
                    ...
                    <CardContent className="pt-4">
                      <div className="space-y-4">
                        <div>
                          ...
                          <p className="text-sm text-gray-600">
                            Grilled chicken breast over mixed greens with cherry tomatoes, cucumber, olives, feta
                            cheese, and a light olive oil and lemon dressing.
                          </p>
                        </div>
                        <div className="flex flex-wrap gap-2">
                          <Badge variant="outline" className="bg-teal-50 text-teal-700">
                    ...
                    <CardContent className="pt-4">
                      <div className="space-y-4">
                        <div>
                          ...
                          <p className="text-sm text-gray-600">
                            Herb-seasoned salmon fillet with a side of roasted broccoli, bell peppers, and zucchini
                        ...
                        <div className="rounded-md bg-blue-50 p-3">
                          <h4 className="mb-1 text-sm font-medium text-blue-800">Why This Works For You</h4>
                          <p className="text-xs text-blue-700">
                            Salmon provides omega-3 fatty acids which improve insulin sensitivity. The fiber-rich
                            vegetables create a balanced meal with minimal impact on blood glucose.
                          </p>
                        </div>
                      </div>
                    </CardContent>
              ...
              <TabsContent value="day2">
                <div className="flex items-center justify-center p-12">
                  <div className="text-center">
                    <h3 className="mb-2 text-lg font-medium text-teal-800">Day 2 Meal Plan</h3>
                    <p className="text-gray-600">Your personalized meal plan for Day 2 will appear here.</p>
                  </div>
                </div>
              </TabsContent>
              ...
              <TabsContent value="day3">
                <div className="flex items-center justify-center p-12">
                  <div className="text-center">
                    <h3 className="mb-2 text-lg font-medium text-teal-800">Day 3 Meal Plan</h3>
                    <p className="text-gray-600">Your personalized meal plan for Day 3 will appear here.</p>
                  </div>
                </div>
              </TabsContent>
              ...
              <TabsContent value="day4">
                <div className="flex items-center justify-center p-12">
                  <div className="text-center">
                    <h3 className="mb-2 text-lg font-medium text-teal-800">Day 4 Meal Plan</h3>
                    <p className="text-gray-600">Your personalized meal plan for Day 4 will appear here.</p>
                  </div>
                </div>
              </TabsContent>
              ...
              <TabsContent value="day5">
                <div className="flex items-center justify-center p-12">
                  <div className="text-center">
                    <h3 className="mb-2 text-lg font-medium text-teal-800">Day 5 Meal Plan</h3>
                    <p className="text-gray-600">Your personalized meal plan for Day 5 will appear here.</p>
                  </div>
                </div>
              </TabsContent>
              ...
              <TabsContent value="day6">
                <div className="flex items-center justify-center p-12">
                  <div className="text-center">
                    <h3 className="mb-2 text-lg font-medium text-teal-800">Day 6 Meal Plan</h3>
                    <p className="text-gray-600">Your personalized meal plan for Day 6 will appear here.</p>
                  </div>
                </div>
              </TabsContent>
              ...
              <TabsContent value="day7">
                <div className="flex items-center justify-center p-12">
                  <div className="text-center">
                    <h3 className="mb-2 text-lg font-medium text-teal-800">Day 7 Meal Plan</h3>
                    <p className="text-gray-600">Your personalized meal plan for Day 7 will appear here.</p>
                  </div>
                </div>
              </TabsContent>
            </Tabs>
